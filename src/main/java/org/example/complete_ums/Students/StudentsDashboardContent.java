...
public class StudentsDashboardContent implements Initializable {
    ...
    @FXML
    private Label LastLoginOn, YourDepartments, YourCourses, TotalStudents, TotalStaff, errorMessageLabel, LibraryUsage, UpcomingExams, AttendancePercent, TotalAccountants,
